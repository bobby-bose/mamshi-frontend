...
const MyOrders = () => {
    ...
    return (
        <>
            <MetaData title="My Orders | Slouch" />
                        ...
                        {loading ? <Loader /> : (
                            <div className="flex flex-col gap-3 sm:mr-4 overflow-hidden">
                                ...
                                <form onSubmit={searchOrders} className="flex items-center justify-between mx-1 sm:mx-0 sm:w-10/12 bg-white border rounded hover:shadow">
                                    ...
                                    <button type="submit" className="h-full text-sm px-1 sm:px-4 py-2.5 text-white bg-gray-700 hover:bg-blue-600 rounded-r flex items-center gap-1">
