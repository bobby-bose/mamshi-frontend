        ...
        <div className="flex gap-4 border-b p-4 sm:pb-8 w-full group overflow-hidden">
            ...
            <div className="flex flex-col gap-5 w-full p-1">
                ...
                <div className="flex justify-between items-start sm:pr-5">
                    ...
                    <button onClick={deleteHandler} className="text-darkGray-400 hover:text-red-500"><span><DeleteIcon /></span></button>
                </div>
                {/* <!-- product title --> */}
                ...
                <div className="flex items-center gap-2 text-2xl font-medium">
                    ...
                    <span className="text-sm text-stone line-through font-normal mt-1">₹{cuttedPrice.toLocaleString()}</span>
