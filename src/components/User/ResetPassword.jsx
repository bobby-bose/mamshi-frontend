...
const ResetPassword = () => {
  ...
  return (
    <>
      <MetaData title="Password Reset | Slouch" />
      ...
      <main class="w-full mt-12 sm:pt-20 sm:mt-0">
        ...
        <div class="flex sm:w-4/6 sm:mt-4 m-auto mb-7 bg-white shadow-lg">
          ...
          <div class="flex-1 overflow-hidden">
            <h2 className="text-center text-2xl font-medium mt-6 text-stone">Reset Password</h2>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div class="flex flex-col w-full gap-4">
                  ...
                  <div class="flex flex-col gap-2.5 mt-2 mb-32">
                    <p class="text-xs text-primary-grey text-left">By continuing, you agree to Slouch's <a href="https://www.google.com/pages/terms" class="text-primary-blue"> Terms of Use</a> and <a href="https://www.google.com/pages/privacypolicy" class="text-primary-blue"> Privacy Policy.</a></p>
