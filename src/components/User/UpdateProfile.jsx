...
const UpdateProfile = () => {
    ...
    return (
        <>
            <MetaData title="Update Profile | Slouch" />
            ...
            <main className="w-full mt-12 sm:pt-20 sm:mt-0">
                ...
                <div className="flex sm:w-4/6 sm:mt-4 m-auto mb-7 bg-white shadow-lg">
                    {/* <!-- sidebar column  --> */}
                    <div className="loginSidebar bg-gray-700 px-9 py-10 hidden sm:flex flex-col gap-4 w-2/5">
                        <h1 className="font-medium text-white text-3xl">Looks like you're new here!</h1>
                        <p className="text-darkGray-200 text-lg pr-2">Sign up with your mobile number to get started</p>
                    </div>
                    {/* <!-- sidebar column  --> */}
                    ...
                    <div className="flex-1 overflow-hidden">
                        ...
                        <h2 className="text-center text-2xl font-medium mt-6 text-stone">Update Profile</h2>
