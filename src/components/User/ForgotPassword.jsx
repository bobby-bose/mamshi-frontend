            ...
            <main className="w-full mt-12 sm:pt-20 sm:mt-0">
                ...
                <div className="flex sm:w-4/6 sm:mt-4 m-auto mb-7 bg-white shadow-lg">
                    ...
                    <div className="flex-1 overflow-hidden">
                        <h2 className="text-center text-2xl font-medium mt-6 text-stone">Forgot Password</h2>
                        ...
                        <div className="text-center py-10 px-4 sm:px-14">
                            ...
                            <Link to="/register" className="font-medium text-sm text-primary-blue">New to Slouch? Create an account</Link>
                        </div>
                        {/* <!-- edit info container --> */}
