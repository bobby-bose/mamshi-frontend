    ...
    return (
        <div className="flex flex-col items-center gap-2 px-2 py-6 relative">
            ...
            <div className="flex flex-col gap-2 items-center">
                {/* <!-- rating badge --> */}
                <span className="text-sm text-stone font-medium flex gap-2 items-center">
                ...
                <div className="flex items-center gap-1.5 text-md font-medium">
                    ...
                    <span className="text-stone line-through text-xs">₹{cuttedPrice.toLocaleString()}</span>
            ...
            {/* <!-- wishlist badge --> */}
            <span onClick={addToWishlistHandler} className={`${itemInWishlist ? "text-red-500" : "hover:text-red-500 text-darkGray-300"} absolute top-5 right-2 cursor-pointer`}><FavoriteIcon sx={{ fontSize: "16px" }} /></span>
            {/* <!-- wishlist badge --> */}
