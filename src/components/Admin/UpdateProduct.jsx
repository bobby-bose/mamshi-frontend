...
const UpdateProduct = () => {
    ...
    return (
        <>
            <MetaData title="Admin: Update Product | Slouch" />
            ...
            <form onSubmit={newProductSubmitHandler} encType="multipart/form-data" className="flex flex-col sm:flex-row bg-white rounded-lg shadow p-4" id="mainform">
                ...
                <div className="flex flex-col gap-3 m-2 sm:w-1/2">
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex justify-between items-center border rounded">
                            ...
                            <span onClick={() => addHighlight()} className="py-2 px-6 bg-gray-700 text-white rounded-r hover:shadow-lg cursor-pointer">Add</span>
                        </div>
                        ...
                        <div className="flex flex-col gap-1.5">
                            {highlights.map((h, i) => (
                                <div className="flex justify-between rounded items-center py-1 px-2 bg-green-50">
                                    ...
                                    <span onClick={() => deleteHighlight(i)} className="text-red-600 hover:bg-darkGray-100 p-1 rounded-full cursor-pointer">
                                        <DeleteIcon />
                                    </span>
                                </div>
                            ))}
                ...
                <div className="flex flex-col gap-2 m-2 sm:w-1/2">
                    ...
                    <div className="flex justify-evenly gap-2 items-center">
                        ...
                        <span onClick={() => addSpecs()} className="py-2 px-6 bg-gray-700 text-white rounded hover:shadow-lg cursor-pointer">Add</span>
                    </div>

                    <div className="flex flex-col gap-1.5">
                        {specs.map((spec, i) => (
                            <div className="flex justify-between items-center text-sm rounded bg-blue-50 py-1 px-2">
                                <p className="text-stone font-medium">{spec.title}</p>
                                <p>{spec.description}</p>
                                <span onClick={() => deleteSpec(i)} className="text-red-600 hover:bg-darkGray-200 bg-darkGray-100 p-1 rounded-full cursor-pointer">
                                    <DeleteIcon />
                                </span>
                            </div>
                        ))}
