        ...
        <div className="flex flex-col gap-3 py-5 pl-2 sm:pl-6 border-b overflow-hidden" key={product}>
                ...
                <div className="flex flex-col sm:gap-5 w-full pr-6">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start pr-5 gap-1 sm:gap-0">
                        <div className="flex flex-col gap-0.5 sm:w-3/5">
                            ...
                            <span className="text-sm text-stone">Seller: {seller}</span>
                        </div>
                        ...
                        <div className="flex flex-col sm:gap-2">
                            ...
                            <span className="text-xs text-stone">7 Days Replacement Policy</span>
                        </div>
                    ...
                    <div className="flex items-baseline gap-2 text-xl font-medium">
                        ...
                        <span className="text-sm text-stone line-through font-normal">₹{(cuttedPrice * quantity).toLocaleString()}</span>
            ...
            <div className="flex justify-between pr-4 sm:pr-0 sm:justify-start sm:gap-6">
                ...
                <div className="flex gap-1 items-center">
                    ...
                    <input className="w-11 border outline-none text-center rounded-sm py-0.5 text-darkGray-700 font-medium text-sm qtyInput" value={quantity} disabled />
